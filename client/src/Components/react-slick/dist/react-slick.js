(function webpackUniversalModuleDefinition (root, factory) {
  if (typeof exports === 'object' && typeof module === 'object') { module.exports = factory(require('react')); } else if (typeof define === 'function' && define.amd) { define(['react'], factory); } else if (typeof exports === 'object') { exports.Slider = factory(require('react')); } else { root.Slider = factory(root.React); }
  ...
  /******/ ([
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const _slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
      ...
      /* harmony import */ const _inner_slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
      /* harmony import */ const json2mq__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
      /* harmony import */ const json2mq__WEBPACK_IMPORTED_MODULE_2___default = /* #__PURE__ */__webpack_require__.n(json2mq__WEBPACK_IMPORTED_MODULE_2__);
      /* harmony import */ const _default_props__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
      /* harmony import */ const _utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
      ...
      const enquire = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.canUseDOM)() && __webpack_require__(16);

      var Slider = /* #__PURE__ */(function (_React$Component) {
        _inherits(Slider, _React$Component);

        const _super = _createSuper(Slider);
        ...
        _createClass(Slider, [{
          ...
          value: function componentDidMount () {
            ...
            if (this.props.responsive) {
              const breakpoints = this.props.responsive.map(function (breakpt) {
              ...
              const query = json2mq__WEBPACK_IMPORTED_MODULE_2___default()({
          ...
          value: function render () {
            ...
            let children = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.toArray(this.props.children); // Children may contain false or null, so we should filter them
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
      /* harmony import */ const react__WEBPACK_IMPORTED_MODULE_0___default = /* #__PURE__ */__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
      /* harmony import */ const _initial_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
      /* harmony import */ const lodash_debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
      /* harmony import */ const lodash_debounce__WEBPACK_IMPORTED_MODULE_2___default = /* #__PURE__ */__webpack_require__.n(lodash_debounce__WEBPACK_IMPORTED_MODULE_2__);
      /* harmony import */ const classnames__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
      ...
      /* harmony import */ const _utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
      /* harmony import */ const _track__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
      /* harmony import */ const _dots__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10);
      /* harmony import */ const _arrows__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(11);
      /* harmony import */ const resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
        ...
        function InnerSlider (props) {
          ...
          _defineProperty(_assertThisInitialized(_this), 'componentDidMount', function () {
            ...
            if (_this.props.lazyLoad) {
              const slidesToLoad = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getOnDemandLazySlides)(_objectSpread(_objectSpread({}, _this.props), _this.state));
          ...
          _defineProperty(_assertThisInitialized(_this), 'updateState', function (spec, setTrackStyle, callback) {
            const updatedState = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.initializedState)(spec);
            spec = _objectSpread(_objectSpread(_objectSpread({}, spec), updatedState), {}, {
              slideIndex: updatedState.currentSlide
            });
            const targetLeft = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getTrackLeft)(spec);
            spec = _objectSpread(_objectSpread({}, spec), {}, {
              left: targetLeft
            });
            const trackStyle = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getTrackCSS)(spec);
          ...
          _defineProperty(_assertThisInitialized(_this), 'ssrInit', function () {
            if (_this.props.variableWidth) {
              ...
              const preClones = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPreClones)(_objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
                slideCount: _this.props.children.length
              }));
              const postClones = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPostClones)(_objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
                slideCount: _this.props.children.length
              }));
            ...
            const childrenCount = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.count(_this.props.children);

            const spec = _objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
              slideCount: childrenCount
            });

            const slideCount = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPreClones)(spec) + Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPostClones)(spec) + childrenCount;
            const trackWidth = 100 / _this.props.slidesToShow * slideCount;
            const slideWidth = 100 / slideCount;
            let trackLeft = -slideWidth * (Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPreClones)(spec) + _this.state.currentSlide) * trackWidth / 100;
          ...
          _defineProperty(_assertThisInitialized(_this), 'progressiveLazyLoad', function () {
            ...
            for (let index = _this.state.currentSlide; index < _this.state.slideCount + Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPostClones)(spec); index++) {
            ...
            for (let _index = _this.state.currentSlide - 1; _index >= -Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.getPreClones)(spec); _index--) {
          ...
          _defineProperty(_assertThisInitialized(_this), 'slideHandler', function (index) {
            ...
            const _slideHandler = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.slideHandler)(_objectSpread(_objectSpread(_objectSpread({
              index: index
            }, _this.props), _this.state), {}, {
              trackRef: _this.track,
          ...
          _defineProperty(_assertThisInitialized(_this), 'changeSlide', function (options) {
            ...
            const targetSlide = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.changeSlide)(spec, options);
          ...
          _defineProperty(_assertThisInitialized(_this), 'keyHandler', function (e) {
            const dir = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.keyHandler)(e, _this.props.accessibility, _this.props.rtl);
          ...
          _defineProperty(_assertThisInitialized(_this), 'swipeStart', function (e) {
            ...
            const state = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.swipeStart)(e, _this.props.swipe, _this.props.draggable);
            state !== '' && _this.setState(state);
          });

          _defineProperty(_assertThisInitialized(_this), 'swipeMove', function (e) {
            const state = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.swipeMove)(e, _objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
              trackRef: _this.track,
              listRef: _this.list,
          ...
          _defineProperty(_assertThisInitialized(_this), 'swipeEnd', function (e) {
            const state = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.swipeEnd)(e, _objectSpread(_objectSpread(_objectSpread({}, _this.props), _this.state), {}, {
              trackRef: _this.track,
              listRef: _this.list,
              slideIndex: _this.state.currentSlide
            }));
          ...
          _defineProperty(_assertThisInitialized(_this), 'render', function () {
            const className = classnames__WEBPACK_IMPORTED_MODULE_3___default()('slick-slider', _this.props.className, {
            ...
            if (_this.props.dots === true && _this.state.slideCount >= _this.props.slidesToShow) {
              let dotProps = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.extractObject)(spec, ['dotsClass', 'slideCount', 'slidesToShow', 'currentSlide', 'slidesToScroll', 'clickHandler', 'children', 'customPaging', 'infinite', 'appendDots']);
            ...
            const arrowProps = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_4__.extractObject)(spec, ['infinite', 'centerMode', 'currentSlide', 'slideCount', 'slidesToShow', 'prevArrow', 'nextArrow']);
...
*/
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      var initializedState = function initializedState (spec) {
        ...
        const slideCount = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.count(spec.children);
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      /* harmony import */ const react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
      /* harmony import */ const react__WEBPACK_IMPORTED_MODULE_0___default = /* #__PURE__ */__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
      /* harmony import */ const classnames__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
      /* harmony import */ const classnames__WEBPACK_IMPORTED_MODULE_1___default = /* #__PURE__ */__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_1__);
      /* harmony import */ const _utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8);
      ...
      const renderSlides = function renderSlides (spec) {
        ...
        const childrenCount = react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.count(spec.children);
        const startIndex = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_2__.lazyStartIndex)(spec);
        const endIndex = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_2__.lazyEndIndex)(spec);
        ...
        _createClass(Dots, [{
          ...
          value: function render () {
            ...
            for (let i = 0; i < dotCount; i++) {
              ...
              const rightBound = infinite ? _rightBound : Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_2__.clamp)(_rightBound, 0, slideCount - 1);

              const _leftBound = rightBound - (slidesToScroll - 1);

              const leftBound = infinite ? _leftBound : Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_2__.clamp)(_leftBound, 0, slideCount - 1);
 ...
 */
        function throttle (callback, delay) {
          let leadingCall = false; let trailingCall = false; let lastCallTime = 0;
          /**
 ...
 */
     ...
     */
          ResizeObserverController.prototype.onTransitionEnd_ = function (_a) {
            const _b = _a.propertyName; const propertyName = _b === void 0 ? '' : _b;
 ...
 */
        function getHTMLElementContentRect (target) {
          ...
          const clientWidth = target.clientWidth; const clientHeight = target.clientHeight;
          ...
          let width = toFloat(styles.width); let height = toFloat(styles.height);
 ...
 */
        function createReadOnlyRect (_a) {
          const x = _a.x; const y = _a.y; const width = _a.width; const height = _a.height;
 ...
 */
    ...
    /* 13 */
    /***/ function (module, exports, __webpack_require__) {
      const camel2hyphen = __webpack_require__(14);
    ...
    /* 16 */
    /***/ function (module, exports, __webpack_require__) {
      const MediaQueryDispatch = __webpack_require__(17);
      module.exports = new MediaQueryDispatch();
      /***/ },
    /* 17 */
    /***/ function (module, exports, __webpack_require__) {
      const MediaQuery = __webpack_require__(18);
 ...
 */
    ...
    /* 18 */
    /***/ function (module, exports, __webpack_require__) {
      const QueryHandler = __webpack_require__(19);
      const each = __webpack_require__(20).each;
