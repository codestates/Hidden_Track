...
const _innerSlider = require('./inner-slider');

const _json2mq = _interopRequireDefault(require('json2mq'));

const _defaultProps = _interopRequireDefault(require('./default-props'));
...
const enquire = (0, _innerSliderUtils.canUseDOM)() && require('enquire.js');

const Slider = /* #__PURE__ */(function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render () {
      ...
      let children = _react.default.Children.toArray(this.props.children); // Children may contain false or null, so we should filter them
