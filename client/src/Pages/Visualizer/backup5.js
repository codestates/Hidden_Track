...
//         console.log(this.audio.current.audio.current)
//         this.audio.current.audio.current.src=this.props.track.soundtrack
...
//         if(this.audio.current.audio.current.paused) {
//             this.source = this.source || this.context.createMediaElementSource(this.audio.current.audio.current);
...
//         <AudioPlayer
//         ref={this.audio}
//         // src={this.props.track.soundtrack}
//         />
//     </>
//     )
//     }
